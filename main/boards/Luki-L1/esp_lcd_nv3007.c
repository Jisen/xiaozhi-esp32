...
static esp_err_t panel_nv3007_disp_on_off(esp_lcd_panel_t *panel, bool off);
...
esp_err_t esp_lcd_new_panel_nv3007(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config, esp_lcd_panel_handle_t *ret_panel){
    ...
    case 16: // RGB565
        nv3007->colmod_val = 0x55;
        nv3007->fb_bits_per_pixel = 16;
        break;
    case 18: // RGB666
        nv3007->colmod_val = 0x66;
...
{0x9d, (uint8_t[]){0x17}, 1, 0},
{0x9e, (uint8_t[]){0xc2}, 1, 0},
{0x8f, (uint8_t[]){0x22, 0x04}, 2, 0},
{0x84, (uint8_t[]){0x90}, 1, 0},
{0x83, (uint8_t[]){0x7B}, 1, 0},
{0x85, (uint8_t[]){0x4F}, 1, 0},
...
{0x6d, (uint8_t[]){0x39}, 1, 0},
{0x7d, (uint8_t[]){0x31}, 1, 0},
{0x61, (uint8_t[]){0x0A}, 1, 0},
{0x71, (uint8_t[]){0x0A}, 1, 0},
{0x6c, (uint8_t[]){0x35}, 1, 0},
{0x7c, (uint8_t[]){0x29}, 1, 0},
{0x62, (uint8_t[]){0x0F}, 1, 0},
{0x72, (uint8_t[]){0x0F}, 1, 0},
{0x68, (uint8_t[]){0x4f}, 1, 0},
{0x78, (uint8_t[]){0x45}, 1, 0},
{0x66, (uint8_t[]){0x33}, 1, 0},
{0x76, (uint8_t[]){0x33}, 1, 0},
{0x6b, (uint8_t[]){0x14}, 1, 0},
{0x7b, (uint8_t[]){0x14}, 1, 0},
{0x63, (uint8_t[]){0x09}, 1, 0},
{0x73, (uint8_t[]){0x09}, 1, 0},
{0x6a, (uint8_t[]){0x13}, 1, 0},
{0x7a, (uint8_t[]){0x16}, 1, 0},
{0x64, (uint8_t[]){0x08}, 1, 0},
{0x74, (uint8_t[]){0x08}, 1, 0},
{0x69, (uint8_t[]){0x07}, 1, 0},
{0x79, (uint8_t[]){0x0d}, 1, 0},
{0x65, (uint8_t[]){0x05}, 1, 0},
{0x75, (uint8_t[]){0x05}, 1, 0},
{0x67, (uint8_t[]){0x33}, 1, 0},
...
{0x53, (uint8_t[]){0x04}, 1, 0},
{0x54, (uint8_t[]){0x04}, 1, 0},
{0x55, (uint8_t[]){0x1b}, 1, 0},
{0x56, (uint8_t[]){0x1b}, 1, 0},
{0xa0, (uint8_t[]){0x2a, 0x24, 0x00}, 3, 0},
{0xa1, (uint8_t[]){0x84}, 1, 0},
{0xa2, (uint8_t[]){0x85}, 1, 0},
{0xa8, (uint8_t[]){0x34}, 1, 0},
{0xa9, (uint8_t[]){0x80}, 1, 0},
{0xaa, (uint8_t[]){0x73}, 1, 0},
{0xAB, (uint8_t[]){0x03, 0x61}, 2, 0},
{0xAC, (uint8_t[]){0x03, 0x65}, 2, 0},
{0xAD, (uint8_t[]){0x03, 0x60}, 2, 0},
{0xAE, (uint8_t[]){0x03, 0x64}, 2, 0},
{0xB9, (uint8_t[]){0x82}, 1, 0},
{0xBA, (uint8_t[]){0x83}, 1, 0},
{0xBB, (uint8_t[]){0x80}, 1, 0},
{0xBC, (uint8_t[]){0x81}, 1, 0},
{0xBD, (uint8_t[]){0x02}, 1, 0},
{0xBE, (uint8_t[]){0x01}, 1, 0},
{0xBF, (uint8_t[]){0x04}, 1, 0},
{0xC0, (uint8_t[]){0x03}, 1, 0},
{0xc4, (uint8_t[]){0x33}, 1, 0},
{0xc5, (uint8_t[]){0x80}, 1, 0},
{0xc6, (uint8_t[]){0x73}, 1, 0},
{0xc7, (uint8_t[]){0x00}, 1, 0},
{0xC8, (uint8_t[]){0x33, 0x33}, 2, 0},
{0xC9, (uint8_t[]){0x5b}, 1, 0},
{0xCA, (uint8_t[]){0x5a}, 1, 0},
{0xCB, (uint8_t[]){0x5d}, 1, 0},
{0xCC, (uint8_t[]){0x5c}, 1, 0},
{0xCD, (uint8_t[]){0x33, 0x33}, 2, 0},
{0xCE, (uint8_t[]){0x5f}, 1, 0},
{0xCF, (uint8_t[]){0x5e}, 1, 0},
{0xD0, (uint8_t[]){0x61}, 1, 0},
{0xD1, (uint8_t[]){0x60}, 1, 0},
{0xB0, (uint8_t[]){0x3a, 0x3a, 0x00, 0x00}, 4, 0},
{0xB6, (uint8_t[]){0x32}, 1, 0},
{0xB7, (uint8_t[]){0x80}, 1, 0},
{0xB8, (uint8_t[]){0x73}, 1, 0},
...
{0xF1, (uint8_t[]){0x0E}, 1, 0},
{0xF9, (uint8_t[]){0x56}, 1, 0},
{0xf2, (uint8_t[]){0x26, 0x1b, 0x0b, 0x20}, 4, 0},
{0xec, (uint8_t[]){0x04}, 1, 0},
...
static esp_err_t panel_nv3007_init(esp_lcd_panel_t *panel){
    ...
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_MADCTL, (uint8_t[]){nv3007->madctl_val,},1),TAG, "send command failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_COLMOD, (uint8_t[]){nv3007->colmod_val,},1),TAG, "send command failed");
...
static esp_err_t panel_nv3007_mirror(esp_lcd_panel_t *panel, bool mirror_x, bool mirror_y){
    ...
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_MADCTL, (uint8_t[]){nv3007->madctl_val}, 1), TAG, "send command failed");
    ESP_LOGW(TAG, "panel_nv3007_mirror:REG %02Xh:%02Xh", LCD_CMD_MADCTL,nv3007->madctl_val);
    return ESP_OK;
}
...
static esp_err_t panel_nv3007_swap_xy(esp_lcd_panel_t *panel, bool swap_axes){
    ...
    ESP_LOGW(TAG, "panel_nv3007_swap_xy:REG %02Xh:%02Xh", LCD_CMD_MADCTL,nv3007->madctl_val);
